...
uint32_t rx_count = 0;
uint32_t tx_count = 0;
uint8_t is_tx_turn = 1;  // Start in TX mode
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
      // Just transmit letter 'A' every second
      uint8_t
{
